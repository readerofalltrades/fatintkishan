...
const projects = [
  {
    ...
    tagline:
      "A 3-button desktop app that wraps a bash fan control script into a clean GUI.",
  ...
  },
  {
    ...
    tagline:
      "A desktop OCR tool that extracts text from images in both English and Bangla.",
